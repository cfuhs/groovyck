...
\athenaa{At the same time, computing is a general tool that we can use
  for solving real-world problems.}
For you to get a computer to do something, you have to tell it what you want it
to do.  You give it a series of instructions in the form of a \emph{program}.
\athenaa{% in a principled way via computer programs.
  The computer then helps us by carrying out these instructions
  very fast, much faster and more reliably than a human.
  In this sense, a program is a description of how to carry out a process
  automatically.
%This can automate processes.
}

\athenaa{Often programs that others have written will do the job.
  However, we don't want to be limited
  to the programs that other people have created.
  We want to tailor our program to the needs of the problem that
  we have at hand.
  % We want to be able
  % to tell the computer precisely what we want our program to achieve.
%what exactly our program should do.
  Writing programs is about expressing our ideas for solving a problem
  clearly and unambiguously. This is a skill increasingly sought
  also outside of the software industry.
  The programs that you can write
%we have written
  may then help solve problems in areas such as
  business,  data science, engineering, and medicine.
}
...
% first
  pointer to
% optional
  further reading for this part, you can find
  an extended description of the purpose
  %setting
  and use of writing computer programs
  in \cite[Chapter~1]{pfe} and \cite[Chapter~1]{tp}.
  % Similarly, later chapters of these textbooks provide additional
  % details and extensions for material provided in the following in the present
  % text.
  }
...
\subsection{\athenaa{Programming language}}
