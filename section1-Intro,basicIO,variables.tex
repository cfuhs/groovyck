...
\athena{This booklet is designed to be self-contained, so you do not
  have to consult any further external resources if you are already
  happy with the explanations and exercises that we are providing.
  Nonetheless, we will point you to several external resources which you
  can look into if you are interested in further explanations, background,
  and (also interactive) exercises.}

\athena{As a first pointer to (optional) further reading, you can find
  an extended elaboration of the setting and uses of writing computer programs
  in \cite[Chapter~1]{pfe} and \cite[Chapter~1]{tp}. These textbooks are
  available for official free download and interactive editions are provided
  as well. Similarly, later chapters of these textbooks provide additional
