...
\athena{This booklet is designed to be self-contained.
  However, we will point you to several external resources which you
  can look into if you are interested in further explanations, additional
...
\athena{As a first pointer to optional further reading, you can find
  ...
  in \cite[Chapter~1]{pfe} and \cite[Chapter~1]{tp}. These textbooks
