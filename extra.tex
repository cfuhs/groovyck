...
practice with Python.  \athenaaa{\textbf{Use only the concepts presented in this
...
see that, for certain series of \athenaaa{integers}, it will not produce the correct
